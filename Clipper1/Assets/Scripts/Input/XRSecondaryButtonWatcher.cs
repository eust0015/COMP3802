...
namespace Input
{
    public class XRSecondaryButtonWatcher : MonoBehaviour
    {
        public delegate void PressEvent(bool pressed);
        public static event PressEvent OnPress;

        public static XRSecondaryButtonWatcher Instance { get; private set; }
        ...
        private void Update()
        {
            ...
            foreach (var device in devicesWithInput)
            {
                ...
                tempState = device.TryGetFeatureValue(CommonUsages.secondaryButton, out inputState) // did get a value
