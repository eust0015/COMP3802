...
namespace Input
{
    public class XRPrimary2DAxisClickWatcher : MonoBehaviour
    {
        public delegate void PressEvent(bool pressed);
        public static event PressEvent OnPress;

        public static XRPrimary2DAxisClickWatcher Instance { get; private set; }
        ...
        private void Update()
        {
            ...
            foreach (var device in devicesWithInput)
            {
                ...
                tempState = device.TryGetFeatureValue(CommonUsages.primary2DAxisClick, out inputState) // did get a value
